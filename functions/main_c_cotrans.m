...
function [profile_t,current_t] = main_c_cotrans(profile_0, bath, init, fin, tc, tstart, last, ss,dT)
    ...
    for t = 1:last/dT
        ...
        [k1,i1] = model_int_cotrans(xn, bath, pump, nmod, mmod, hmod, gnmod, gkmod, leak_k, leak_na, leak_cl,o2D,temp,cotrans1,cotrans2);               % Runge-Kutta Method
        [k2,i2] = model_int_cotrans(xn+dT/2*k1,bath,pump, nmod, mmod, hmod, gnmod, gkmod, leak_k, leak_na, leak_cl,o2D,temp,cotrans1,cotrans2);
        [k3,i3] = model_int_cotrans(xn+dT/2*k2,bath,pump,nmod, mmod, hmod, gnmod, gkmod, leak_k, leak_na, leak_cl,o2D,temp,cotrans1,cotrans2);
        [k4,i4] = model_int_cotrans(xn+dT*k3,bath,pump, nmod, mmod, hmod, gnmod, gkmod, leak_k, leak_na, leak_cl,o2D,temp,cotrans1,cotrans2);
